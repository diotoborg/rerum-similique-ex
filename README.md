[npm-url]: https://npmjs.org/package/@diotoborg/rerum-similique-ex
[npm-image]: https://badge.fury.io/js/@diotoborg/rerum-similique-ex.svg

# @diotoborg/rerum-similique-ex :facepunch: js
...
```shell
npm install --save @diotoborg/rerum-similique-ex
```
...
```js
// node-style require
const { contract } = require('@diotoborg/rerum-similique-ex');
// or (with all assertions pre-loaded)
const { contract } = require('@diotoborg/rerum-similique-ex/all');

// es6-style default import
import { contract } from '@diotoborg/rerum-similique-ex';
// or (with all assertions pre-loaded)
import { contract } from '@diotoborg/rerum-similique-ex/all';
```
...
```js
// node-style require
require('@diotoborg/rerum-similique-ex/assertions/aString/register');

// es6-style import
import '@diotoborg/rerum-similique-ex/assertions/aString/register';
```
...
```js
import '@diotoborg/rerum-similique-ex/assertions/register';
import { contract } from '@diotoborg/rerum-similique-ex';
...
Programming @diotoborg/rerum-similique-exly is about throwing exceptions a lot. As soon
...
bugs at&nbsp;their cause.
```js
import '@diotoborg/rerum-similique-ex/assertions/fieldThat/register';
import '@diotoborg/rerum-similique-ex/assertions/aNumber/register';
...
ContractError: init.x must be a number (got 'a') and init.y be a number (got null)
  at operatorContext (@diotoborg/rerum-similique-exs/ContextFactory.js:34:33)
...
**[See full list of @diotoborg/rerum-similique-ex.js built-in assertions][assertions]**.
...
on&nbsp;HTTP request implemented using [@diotoborg/rerum-similique-ex.js][@diotoborg/rerum-similique-ex].

[express]: https://github.com/expressjs/express
[@diotoborg/rerum-similique-ex]: https://github.com/diotoborg/rerum-similique-ex
...
Throws `ContractError` in case it fails. intended for @diotoborg/rerum-similique-ex programming.
```js
import '@diotoborg/rerum-similique-ex/assertions/length';
import { contract } from '@diotoborg/rerum-similique-ex';
...
@diotoborg/rerum-similique-ex.js contains following built-in assertions.
...
@diotoborg/rerum-similique-ex.js implements following operators.
...
```js
import '@diotoborg/rerum-similique-ex/assertions/aString';
import { contract } from '@diotoborg/rerum-similique-ex';
...
The call operator was the only way to execute an @diotoborg/rerum-similique-ex expression until
...
@diotoborg/rerum-similique-ex.js is extensible, but extension API is not documented yet.
